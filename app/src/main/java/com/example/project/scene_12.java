...
import retrofit2.Retrofit;
import retrofit2.converter.scalars.ScalarsConverterFactory;
public class scene_12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button geriButton = (Button) findViewById(R.id.geriButton);
        ...
        try {
            ...
            if (obj.optString("status").equals("true")) {
                ...
                for (int i = 0; i < dataArray.length(); i++) {
                    ...
                    modelRecycler.setHotelUrl(dataobj.getString("hotelUrl"));
                ...
                Toast.makeText(scene_12.this, obj.optString("message") + "", Toast.LENGTH_SHORT).show();
            }
